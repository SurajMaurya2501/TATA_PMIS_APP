...
class OAndMDashboardModel {
  OAndMDashboardModel({
    ...
    required this.chargersFaults,
    required this.electricalFaults,
  ...
  factory OAndMDashboardModel.fromJson(Map<String, dynamic> json) {
    return OAndMDashboardModel(
      ...
      chargersFaults: json["chargersFaults"] ?? '',
      electricalFaults: json["electricalFaults"] ?? '',
  ...
  DataGridRow dataGridRow() {
    return DataGridRow(cells: <DataGridCell>[
      ...
      DataGridCell(columnName: 'chargerFaults', value: chargersFaults),
      DataGridCell(columnName: 'electricalFaults', value: electricalFaults),
      DataGridCell(
